...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/absentee">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/absentee/styles.bundle.css`
      * `scripts`: `news/projects/all/absentee/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/absentee/",
      "url": "http://static.startribune.com/news/projects-staging/all/absentee/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/absentee/",
      "url": "http://static.startribune.com/news/projects/all/absentee/"
    }
  }
}
```
