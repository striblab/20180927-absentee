    ...
    self.chartCounts = c3.generate({
        ...
        data: {
              ...
              columns: [
                  ...
                  ['2016', 15213, 33298, 42146, 66474, 99150, 165863, 234814],
                  ['2018', 11353, 31169, 42916, 74222, 90249, 160329, 204657]
              ],
          type: 'spline'
        },
          legend: {
          ...
          axis: {
              ...
              x: {
                type: 'category',
                categories: ['Week 1','Week 2','Week 3','Week 4','Week 5','Week 6','Nov. 5-6'],
